      ...
      <div className={styles.container}>
        ...
        <div className={styles.second}>
          <div className={styles.content}>
            ...
            from one hour to 28 days, and review the instant quote provided.
            After confirming your details and making payment online, the policy
            activates instantly, with digital documents sent via email. This
