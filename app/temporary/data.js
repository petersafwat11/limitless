...
export const benifits = [
  {
    title: "A Valid UK/EU driving license",
    img: {
      src: "/svg/valid.svg",
      alt: "uninsured",
      width: 130,
  ...
  {
    title: "The car owners permission",
    img: {
      src: "/svg/owner.svg",
      alt: "no-road-tax",
      width: 130,
...
export const temporaryCoverDetails = {
  covered: {
    title: "What's covered",
    features: [
      "Damage to your vehicle up to £100k",
